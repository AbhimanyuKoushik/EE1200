...
\begin{itemize}
    \item Switching between modes does not reset the counter value.
    \item The counter continues in the selected direction from its current state.
    \item No invalid BCD states (e.g., 1010 to 1111) are observed.
\end{itemize}
